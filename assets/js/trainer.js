...
function renderData(data) {
    ...
    data.forEach((d) => {
        ...
        document.getElementById('trainerTable').innerHTML += `
                            <tr>
                                <td class="px-6 py-3">${escHtml(d.trainer)}</td>
                                <td class="px-6 py-3">${escHtml(d.contact)}</td>
                                <td class="px-6 py-3">${escHtml(d.rate)}</td>
                                <td class="px-6 py-3">${escHtml(d.capacity)}</td>
                                <td class="px-6 py-3">${escHtml(d.trainees)}</td>
                                <td class="px-6 py-3">
