...
<aside id="aside" class="fixed md:relative z-50 -translate-x-full md:translate-x-0 transition-transform flex flex-col gap-6 bg-violet-800 h-screen w-70 md:w-80 py-6">
    ...
    <a href="./index.php" class="flex justify-between px-5 md:px-10">
        ...
        <button id="close" class="md:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="25" height="25" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5l7 7l7 -7M12 12h0M5 19l7 -7l7 7">
                    <animate fill="freeze" attributeName="d" dur="0.4s" values="M5 5l7 0l7 0M5 12h14M5 19l7 0l7 0;M5 5l7 7l7 -7M12 12h0M5 19l7 -7l7 7"></animate>
                </path>
            </svg>
        </button>
    </a>
    ...
    <div class="flex flex-col gap-2 border-t-2 border-violet-700 pt-4">
        ...
        <nav class="flex flex-col">
            ...
            <a href="./index.php?url=dashboard" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'dashboard' ? 'bg-violet-700' : '' ?> hover:bg-violet-700">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 5a2 2 0 0 1 2-2h6v18H4a2 2 0 0 1-2-2zm12-2h6a2 2 0 0 1 2 2v5h-8zm0 11h8v5a2 2 0 0 1-2 2h-6z"></path>
                </svg>
            ...
            <a href="./index.php?url=customers" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'customers' ? 'bg-violet-700' : '' ?> hover:bg-violet-700">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 16 16" style="color: rgb(255, 255, 255);">
                    <path fill="currentColor" d="M15 14s1 0 1-1s-1-4-5-4s-5 3-5 4s1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276c.593.69.758 1.457.76 1.72l-.008.002l-.014.002zM11 7a2 2 0 1 0 0-4a2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0a3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904c.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724c.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0a3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4a2 2 0 0 0 0-4"></path>
                </svg>
            ...
            <a href="./index.php?url=assign" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'assign' ? 'bg-violet-700' : '' ?> hover:bg-violet-700">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                    <g fill="none">
                        <path d="M9.708 2.5a2.5 2.5 0 0 1 4.584 0H20.5v19h-17v-19z" clip-rule="evenodd"></path>
                        <path stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M9.708 2.5a2.5 2.5 0 0 1 4.584 0H20.5v19h-17v-19z" clip-rule="evenodd"></path>
                        <path stroke="currentColor" stroke-linecap="square" stroke-width="2" d="m7.758 12.414l2.828 2.829l5.657-5.657"></path>
                    </g>
                </svg>
            ...
            <a href="./index.php?url=visits" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'visits' ? 'bg-violet-700' : '' ?> hover:bg-violet-700">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                    <g fill="none">
                        <path d="M9.708 2.5a2.5 2.5 0 0 1 4.584 0H20.5v19h-17v-19z" clip-rule="evenodd"></path>
                        <path stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M9.708 2.5a2.5 2.5 0 0 1 4.584 0H20.5v19h-17v-19z" clip-rule="evenodd"></path>
                        <path stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M17 18a3 3 0 0 0-3-3h-4a3 3 0 0 0-3 3m7.5-8.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0Z"></path>
                    </g>
                </svg>
    ...
    <div class="flex flex-col gap-2 border-t-2 border-violet-700 pt-4">
        ...
        <nav class="flex flex-col">
            ...
            <a href="./index.php?url=memberships" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'memberships' ? 'bg-violet-700' : '' ?> hover:bg-violet-700">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                    <path fill="currentColor" d="M22 3H2c-1.09.04-1.96.91-2 2v14c.04 1.09.91 1.96 2 2h20c1.09-.04 1.96-.91 2-2V5a2.074 2.074 0 0 0-2-2m0 16H2V5h20zm-8-2v-1.25c0-1.66-3.34-2.5-5-2.5s-5 .84-5 2.5V17zM9 7a2.5 2.5 0 0 0-2.5 2.5A2.5 2.5 0 0 0 9 12a2.5 2.5 0 0 0 2.5-2.5A2.5 2.5 0 0 0 9 7m5 0v1h6V7zm0 2v1h6V9zm0 2v1h4v-1z"></path>
                </svg>
        ...
        <div class="flex flex-col gap-2 border-t-2 border-violet-700 pt-4">
            ...
            <nav class="flex flex-col">
                ...
                <a href="./index.php?url=staffs" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'staffs' ? 'bg-violet-700' : '' ?> hover:bg-violet-700">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                        <path fill="currentColor" d="M12 4a4 4 0 1 0 0 8a4 4 0 0 0 0-8M6 8a6 6 0 1 1 12 0A6 6 0 0 1 6 8m2 10a3 3 0 0 0-3 3a1 1 0 1 1-2 0a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5a1 1 0 1 1-2 0a3 3 0 0 0-3-3z"></path>
                    </svg>
    ...
    <div class="flex flex-col gap-2 border-t-2 border-violet-700 pt-4">
        <nav class="flex flex-col">
            ...
            <a class="flex gap-3 md:gap-4 items-center cursor-pointer px-5 md:px-10 py-2 md:py-3 hover:bg-violet-700" id="logout">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="26" height="26" viewBox="0 0 24 24" style="color: rgb(255, 255, 255);">
                    <path fill="currentColor" fill-rule="evenodd" d="M3 5c0-1.1.9-2 2-2h8v2H5v14h8v2H5c-1.1 0-2-.9-2-2zm14.176 6L14.64 8.464l1.414-1.414l4.95 4.95l-4.95 4.95l-1.414-1.414L17.176 13H10.59v-2z"></path>
                </svg>
