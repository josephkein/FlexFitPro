...
<!-- SIDE BAR -->
<aside id="aside" class="fixed md:relative z-50 -translate-x-full md:translate-x-0 transition-transform flex flex-col gap-6 bg-violet-600 h-screen w-70 md:w-80 py-6">

    <!-- LOGO -->
    <a href="./index.php" class="flex justify-between px-5 md:px-10">
        <div class="flex gap-4 items-center cursor-pointer">
            <div class="flex items-center justify-center bg-violet-400 rounded-xl h-10 w-10 md:h-14 md:w-14">
    ...
    <div class="flex flex-col gap-2 border-t-2 border-violet-500 pt-4">
        ...
        <nav class="flex flex-col">
            ...
            <a href="./index.php?url=customers" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'customers' ? 'bg-violet-500' : '' ?> hover:bg-violet-500">
            ...
            <a href="./index.php?url=trainers" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'trainers' ? 'bg-violet-500' : '' ?> hover:bg-violet-500">
            ...
            <a href="./index.php?url=assign" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'assign' ? 'bg-violet-500' : '' ?> hover:bg-violet-500">
            ...
            <a href="./index.php?url=visits" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'visits' ? 'bg-violet-500' : '' ?> hover:bg-violet-500">
    ...
    <div class="flex flex-col gap-2 border-t-2 border-violet-500 pt-4">
        ...
        <nav class="flex flex-col">
            ...
            <a href="./index.php?url=payments" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'payments' ? 'bg-violet-500' : '' ?> hover:bg-violet-500">
            ...
            <a href="./index.php?url=memberships" class="flex gap-3 md:gap-4 items-center px-5 md:px-10 py-2 md:py-3 <?= $url == 'memberships' ? 'bg-violet-500' : '' ?> hover:bg-violet-500">
    ...
    <div class="flex flex-col gap-2 border-t-2 border-violet-500 pt-4">
        <nav class="flex flex-col">
            ...
            <a class="flex gap-3 md:gap-4 items-center cursor-pointer px-5 md:px-10 py-2 md:py-3 hover:bg-violet-500" id="logout">
