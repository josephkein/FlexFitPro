            ...
            <main class="flex flex-col w-full px-6 mt-5 gap-6">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div class="flex items-center gap-2 bg-white border border-gray-200 rounded px-4 py-2 w-full max-w-sm">
                        ...
                        <input id="searchInput" type="text" placeholder="Search by name or member ID..." class="outline-none text-md w-full">
                    </div>
                    <div class="flex gap-3 items-center flex-wrap">
                        <input id="dateFilter" type="date" value="" class="border border-gray-200 rounded px-3 py-2 text-md bg-white outline-none focus:border-violet-400">
